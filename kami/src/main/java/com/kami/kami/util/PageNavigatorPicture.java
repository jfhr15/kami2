package com.kami.kami.util;


public class PageNavigatorPicture {
	// 멤버
	private final int countPerPage = 12;	// 한 페이지당 글개수
	...
	public PageNavigatorPicture(int currentPage, int totalRecordCount) {
