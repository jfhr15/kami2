...
<body>
	...
	<div>
		<div class="topA">
			<div class="picTop">${picture.name}</div>
		</div>
		<div class="picA">
			<img class="imgA" src="img/${picture.savfile}" alt="" />
		</div>
		<div class="bA">
			<a id="btA" href="goReservation2?pictureSeq=${picture.pictureSeq}" class="btnA" type="button">예약</a>
		</div> 
	</div>
